...
To run the whole manager the way users do, `docker compose up --build`.
...
- Total title length must not exceed 80 characters
...
10. After publishing keep your ear to the ground for any feedback and comments in [Pull requests](https://github.com/kajusnau/palisade/pulls).
